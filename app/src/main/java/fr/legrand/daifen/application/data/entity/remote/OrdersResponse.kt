...
data class OrdersResponse(
    @Selector("#contenu form + p b")
    var round: String? = null,
    @Selector("#connaissance b")
    var currentKnowledge: String? = null,
    @Selector("#contenu div > h2:nth-of-type(1) + #connaissance + p:not(#connaissance)")
    var buildingsDisabledWithKnowledge: String? = null,
    @Selector("#contenu div > h2:nth-of-type(1) + p:not(#connaissance)")
    var buildingsDisabledWithoutKnowledge: String? = null,
    @Selector("#contenu div > h2:nth-of-type(1) + #connaissance + ul + p:not(#connaissance)")
    var troopsDisabledWithKnowledgeWithBuildings: String? = null,
    @Selector("#contenu div > h2:nth-of-type(1) + #connaissance + p:not(#connaissance) + p:not(#connaissance)")
    var troopsDisabledWithKnowledgeWithoutBuildings: String? = null,
    @Selector("#contenu div > h2:nth-of-type(1) + ul + p:not(#connaissance)")
